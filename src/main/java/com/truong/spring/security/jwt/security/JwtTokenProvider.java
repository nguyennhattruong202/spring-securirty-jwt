...
public class JwtTokenProvider {
    ...
    public JwtTokenProvider(@Value("${app.jwt.secret}") String jwtSecretKey, @Value("${app.jwt.expiration}") long jwtExpirationInMs) {
    ...
    public String generateToken(CustomUserDetails customUserDetails) {
        ...
        return Jwts.builder()
                .subject(Long.toString(customUserDetails.getUserId()))
